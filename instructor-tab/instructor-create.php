                    ...
                    <div class="card-body1">
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="firstname" class="form-control1">
                            </div>
                            <div class="mb-3">
                                <label>Instructor Middle Name</label>
                                <input type="text" name="middlename" class="form-control1">
                            </div>
                            <div class="mb-3">
                                <label>Instructor Last Name</label>
                                <input type="text" name="lastname" class="form-control1">
                            </div>
                            <div class="mb-3">
